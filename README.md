...
```
cd existing_repo
git remote add origin https://git.tpdev.de/tsa/development/ausbildung/2024/webapp-contacts.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.tpdev.de/tsa/development/ausbildung/2024/webapp-contacts/-/settings/integrations)
